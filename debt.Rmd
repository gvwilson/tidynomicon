...
Another feature of R that can surprise the unwary is [copy-on-modify](glossary.html#copy-on-modify),
...
(We need to use [aliases](glossary.html#alias) because `address(first$left)` doesn't work:
