...
See @Wils2018 for a description of the process used to design these lessons.
...
The exercises provide a different perspective on the concepts that the lessons introduce.
To do them:
...
You will need various libraries (called "packages" in R) as we go along;
we will install these when and as needed.
