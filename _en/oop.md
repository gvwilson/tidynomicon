...
Instead,
they add [attributes](#g:attribute) to data,
then write specialized version of [generic functions](#g:generic-function)
...
- A [constructor](#g:constructor) called `new_two_d`
  that creates objects of our class.
- An optional [validator](#g:validator) called `validate_two_d`
  that checks the consistency and correctness of an object's values.
- An optional [helper](#g:helper), simply called `two_d`,
