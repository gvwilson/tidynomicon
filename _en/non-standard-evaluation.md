...
objectives:
  ...
  - "Explain what environments and expressions are and how they relate."
keypoints:
  - "FIXME"
---
...
> is called **evaluating** the expression.
>
...
so it creates a **promise** to hold:
...
Instead,
we should use a function called `enquo` which returns an object called a **quosure**
...
**evaluating functions** and **quoting functions**.
