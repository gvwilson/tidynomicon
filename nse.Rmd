...
```{r echo=FALSE, fig.cap="Python Step 1"}
...
```{r echo=FALSE, fig.cap="Python Step 2"}
if (knitr::is_latex_output()) {
...
```{r echo=FALSE, fig.cap="Python Step 3"}
if (knitr::is_latex_output()) {
...
```{r echo=FALSE, fig.cap="Python Step 4"}
if (knitr::is_latex_output()) {
...
```{r echo=FALSE, fig.cap="Python Step 5"}
if (knitr::is_latex_output()) {
...
```{r echo=FALSE, fig.cap="Python Step 6"}
if (knitr::is_latex_output()) {
...
```{r echo=FALSE, fig.cap="Python Step 7"}
if (knitr::is_latex_output()) {
...
```{r echo=FALSE, fig.cap="Python Step 8"}
if (knitr::is_latex_output()) {
...
```{r echo=FALSE, fig.cap="R Step 10"}
if (knitr::is_latex_output()) {
...
Instead,
we should use a function called `enquo` which returns an object called a [quosure](glossary.html#quosure)
